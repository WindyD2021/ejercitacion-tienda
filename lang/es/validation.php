...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes definir mensajes de error personalizados para los atributos usando el formato
    | 'attribute.rule' para nombrar las líneas. Esto hace que sea fácil especificar
    | una línea de idioma personalizada para una regla de validación dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma son utilizadas para intercambiar atributos de
    | campos de entrada con algo más amigable para el usuario, como "E-Mail Address" en lugar
    | de "email". Esto simplemente ayuda a hacer los mensajes más expresivos.
    |
    */
