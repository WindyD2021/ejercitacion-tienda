...
<body class="font-sans antialiased bg-white ">
    ...
    <!-- Este es el content donde se insertará el contenido -->
    <main class="max-w-full mx-auto px-4">
        @yield('content')
    </main>
            ...
            <div>
                <form action="{{ route('subscribe') }}" method="POST" class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center mb-4"> <!-- Contenedor para la opción de términos -->
                        ...
                        <label for="terms"
                            class="text-gray-600 text-sm">{{ __('Please accept our Terms and Conditions') }}.</label>
                    </div>
                    <button type="submit"
    ...
    <footer class="mt-8 border-t pt-4">
        ...
        <p class="text-sm text-center">&copy; {{ date('Y') }}
            {{ __('Panini Argentina store. All rights reserved') }}.</p>
    </footer>
